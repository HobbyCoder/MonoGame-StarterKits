...
namespace com.example.dungeons
{
    ...
    public abstract class PurchaseObserver
    {
        ...
        private static readonly Type[] START_INTENT_SENDER_SIG = new Type[] { typeof(IntentSender), typeof(Intent), typeof(int), typeof(int), typeof(int) };
        ...
        public abstract void onBillingSupported(bool supported);
